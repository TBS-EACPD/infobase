...
export EMAIL_BACKEND_OAUTH_SERVICE_ID=$(lpass show EMAIL_BACKEND_OAUTH_SERVICE_ID --notes)
export EMAIL_BACKEND_OAUTH_SERVICE_PRIVATE_KEY=$(lpass show EMAIL_BACKEND_OAUTH_SERVICE_PRIVATE_KEY --notes | base64 --decode)
...
echo "EMAIL_BACKEND_OAUTH_SERVICE_ID: '$EMAIL_BACKEND_OAUTH_SERVICE_ID'" >> $scratch/envs.yaml
echo "EMAIL_BACKEND_OAUTH_SERVICE_PRIVATE_KEY: '$EMAIL_BACKEND_OAUTH_SERVICE_PRIVATE_KEY'" >> $scratch/envs.yaml
