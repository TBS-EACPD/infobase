...
// of the table spec
//
require('../../graphs/welcome_mat/welcome_mat');
...
Statistics.create_and_register({
  id: 'table12_program_info', 
  table_deps: [ 'table12'],
  level: 'program',
  compute: (subject, tables, infos, add, c) => {
    const table = tables.table12;
...
Statistics.create_and_register({
  id: 'table12_crso_info', 
  table_deps: [ 'table12'],
  level: 'crso',
  compute: (subject, tables, infos, add, c) => {
    const table12 = tables.table12;
    const q = table12.q(subject);
