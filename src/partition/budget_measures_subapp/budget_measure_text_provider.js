...
import metatdata_text from '../../metadata/data_sources.yaml';
import { TextMaker as StandardTextMaker } from '../../util_components.js';
import { create_text_maker } from '../../models/text.js';

export const text_maker = create_text_maker([budget_measure_text, route_text, controls_text, a11y_text, partition_text, metatdata_text]);
