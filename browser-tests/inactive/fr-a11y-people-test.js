...
fixture `French A11y test`// declare the fixture
  .page `http://localhost:8080/build/InfoBase/index-basic-fra.html#orgs/gov/gov/infograph/people`;  // specify the start page
...
test('French A11Y app people page boots up', async t => {
  await t
    ...
    .expect(Selector(people_header_sel).innerText).contains("Population totale");
});