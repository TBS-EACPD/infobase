...
gcloud functions deploy prod-api-${CURRENT_SHA} --entry-point app --stage-bucket prod-api-staging-bucket --runtime nodejs8 --trigger-http --env-vars-file $scratch/envs.yaml > /dev/null
