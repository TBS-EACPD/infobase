...
gcloud functions deploy $CIRCLE_BRANCH --entry-point app --stage-bucket api-staging-bucket --runtime nodejs20 --trigger-http --allow-unauthenticated --env-vars-file ./envs.yaml
