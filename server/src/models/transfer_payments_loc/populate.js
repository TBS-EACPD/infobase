...
export default function ({ models }) {
  const csv_transfer_payments_by_loc = get_standard_csv_file_rows('transfer_payments_by_loc.csv');
  ...
  const transfer_payments_by_loc = csv_transfer_payments_by_loc.map(fields => ({
    ...fields,
  ...
  _.each(transfer_payments_by_loc, transfer_payment => TransferPaymentLocationRecord.register(transfer_payment));
