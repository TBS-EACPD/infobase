...
export default function(model_singleton){
  ...
  model_singleton.define_model("OrgVoteStatEstimates", OrgVoteStatEstimatesSchema);
  model_singleton.define_model("OrgTransferPayments", OrgTransferPaymentsSchema);
  ...
  const loaders = {
    orgVoteStatPa_loader: create_resource_by_foreignkey_attr_dataloader(OrgVoteStatPa, 'dept_code'),
    OrgVoteStatQfr_loader: create_resource_by_foreignkey_attr_dataloader(OrgVoteStatQfr, 'dept_code'),
    orgVoteStatEstimates_loader: create_resource_by_foreignkey_attr_dataloader(OrgVoteStatEstimates, 'dept_code'),
    orgTransferPayments_loader: create_resource_by_foreignkey_attr_dataloader(OrgTransferPayments, 'dept_code'),
    programSobjs_loader: create_resource_by_foreignkey_attr_dataloader(ProgramSobjs, 'program_id'),
    programVoteStat_loader: create_resource_by_foreignkey_attr_dataloader(ProgramVoteStat, 'program_id'),
    programSpending_loader: create_resource_by_foreignkey_attr_dataloader(ProgramSpending, 'program_id'),
    programFte_loader: create_resource_by_foreignkey_attr_dataloader(ProgramFte, 'program_id'),
  };
