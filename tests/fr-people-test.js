...
fixture `French test`// declare the fixture
  .page `http://localhost:8080/build/InfoBase/index-fra.html#orgs/gov/gov/infograph/people`;  // specify the start page
...
test('(French) app boots and loads people page data', async t => {
  await t
    // Use the assertion to check if the actual header text is equal to the expected one
    .expect(Selector(people_desc_sel).innerText).contains("moyen");
});