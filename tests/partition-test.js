...
fixture `Main app tests`// declare the fixture
  .page `http://localhost:8080/build/InfoBase/index-eng.html#partition/dept/exp`;  // specify the start page
...
test('App boots and loads partition page data', async t => {
  await t
    // Use the assertion to check if the actual header text is equal to the expected one
    .expect(Selector(partition_desc_sel).innerText).contains("Select");
});