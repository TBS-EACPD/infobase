...
fixture `French test`// declare the fixture
  .page `http://localhost:8080/build/InfoBase/index-fra.html#orgs/gov/gov/infograph/results`;  // specify the start page
...
test('(French) app boots and loads results page data', async t => {
  await t
    // Use the assertion to check if the actual header text is equal to the expected one
    .expect(Selector(results_desc_sel).innerText).contains("adopté");
});