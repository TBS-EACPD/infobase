...
fixture `French A11y test`// declare the fixture
  .page `http://localhost:8080/build/InfoBase/index-basic-fra.html#orgs/gov/gov/infograph/intro`;  // specify the start page
...
test('French A11Y app about gov page boots up', async t => {
  await t
    // Use the assertion to check if the actual header text is equal to the expected one
    .expect(Selector(aboutgov_desc_sel).innerText).contains("Combien nous dépensons");
});