...
const financial_link_sel = "#app-focus-root > div > div > div > div > #budget_measures_panel > section.panel.panel-info.mrgn-bttm-md" +
...
test('A11Y app finance page boots up', async t => {
  await t
    ...
    .expect(Selector(financial_link_sel).innerText).contains("provides");
});