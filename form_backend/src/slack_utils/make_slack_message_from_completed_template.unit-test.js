import { make_slack_message_from_completed_template } from "./make_slack_message_from_completed_template.js";

describe("make_slack_message_from_completed_template", () => {
  it("properly generates body content", () => {
    ...
    const expected_body_content = `${template_name}\n
  Select all that apply:\n    bug, typo\n
  Did you find what you were looking for on GC InfoBase?\n    yes\n
