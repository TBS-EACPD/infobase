...
// Interim: Azure-hosted index shells still use #footer_survey_link_area.
// New HTML shells omit that node; no-op in that case.
export class InsertRuntimeFooterLinks extends React.Component {
  constructor() {
    ...
    this.state = {
      static_footer_links: footer_survey_link_ul
        ? footer_survey_link_ul.innerHTML
        : null,
    };
  }
  render() {
    ...
    if (!footer_survey_link_ul || this.state.static_footer_links === null) {
      return null;
    }
