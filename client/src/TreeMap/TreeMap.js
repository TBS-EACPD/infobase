...
const blue_scale = d3.scaleSequential(d3.interpolateRgbBasis(sequentialBlues.slice(0,4))).clamp(true);
const red_scale = d3.scaleSequential(d3.interpolateRgbBasis(sequentialReds.slice(0,4))).clamp(true);
