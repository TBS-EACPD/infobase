/* 
Edited version of Nivo Bar graph, this allows "bar labels" for all bar heights (including zero)
The current version of Nivo Bar doesn't display the bar label if the height is 0
Changes Made:
