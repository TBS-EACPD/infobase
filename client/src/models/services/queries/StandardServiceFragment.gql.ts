...
export const StandardServiceFragmentFragmentDoc = gql`
  ...
  is_missing_program_activity_codes
  first_active_year
  last_active_year
  name
  description
