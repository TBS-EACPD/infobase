...
Subject.BudgetMeasure = class BudgetMeasure extends static_subject_store(){
  ...
  static get main_estimates_budget_links(){
    return {
      ...
      2019: {
        en: "https://www.canada.ca/en/treasury-board-secretariat/services/planned-government-spending/sources-uses-budget-measures-organization.html",
        fr: "https://www.canada.ca/fr/secretariat-conseil-tresor/services/depenses-prevues/provenance-utilisations-fonds-mesures-budget-organisation.html",
      }[window.lang],
    };
  }
