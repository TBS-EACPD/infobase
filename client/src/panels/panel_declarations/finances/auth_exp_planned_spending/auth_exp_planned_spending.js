...
const { std_years, extended_planning_years, estimates_years } = year_templates;
...
const calculate = function (subject, info, options) {
  ...
  const planned_spending_values = programSpending
    .q(query_subject)
    .sum(extended_planning_years, { as_object: false });
  ...
  const data_series = _.chain([
    ...
    subject.has_planned_spending && {
      key: "planned_spending",
      untrimmed_year_templates: extended_planning_years,
      untrimmed_values: planned_spending_values,
      year_templates: extended_planning_years,
  ...
  const additional_info = {
    ...
    last_planned_year: run_template(_.last(extended_planning_years)),
    gap_year:
