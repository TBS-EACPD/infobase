...
describe("result_components",()=>{
  it("renders correctly",()=>{
    ...
    const ind = {
      ...
      "name": "The current year producers’ net market income plus Business Risk Management program payments as a percent of the previous five year average",
      "doc": "drr17",
      "target_year": 2018,
      "target_month": 3,
      ...
      "target_explanation": "Strong sector income growth has lead to this indicator exceeding its targets.",
    ...
    act(() => {
      render(
        <IndicatorDisplay indicators={[ind]} />,
        container
      );
    });
