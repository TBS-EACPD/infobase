...
export const declare_portfolio_structure_intro_panel = () => declare_panel({
...
export const declare_portfolio_structure_related_panel = () => declare_panel({
...
export const declare_related_program_structure_panel = () => declare_panel({
...
export const declare_tag_fed_structure_panel = () => declare_panel({
...
export const declare_sibling_tags_panel = () => declare_panel({
...
export const declare_crso_in_gov_panel = () => declare_panel({
...
export const declare_crso_links_to_other_crso_panel = () => declare_panel({
