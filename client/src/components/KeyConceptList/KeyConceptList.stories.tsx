...
type KeyConceptListProps = ComponentProps<typeof KeyConceptList>;

const Template: Story<KeyConceptListProps> = (args) => (
  <KeyConceptList {...args} />
);

const lorem_ipsum1 = `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce quis risus
...
const lorem_ipsum2 = `Etiam id magna mollis, pharetra metus cursus, scelerisque ante. Nullam
...
const lorem_ipsum3 = `Integer laoreet, eros eget ullamcorper interdum, odio lorem eleifend libero,
