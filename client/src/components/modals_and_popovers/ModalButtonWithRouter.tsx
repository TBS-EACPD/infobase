...
type ModalButtonWithRouterProps = RouteComponentProps<{ options: string }> & {
...
interface ModalButtonWithRouterState {
  show_modal: boolean;
}

class ModalButtonWithRouter_ extends React.Component<
  ModalButtonWithRouterProps,
  ModalButtonWithRouterState
> {
  constructor(props: ModalButtonWithRouterProps) {
    super(props);
...
const ModalButtonWithRouter = withRouter(ModalButtonWithRouter_);
export { ModalButtonWithRouter };
