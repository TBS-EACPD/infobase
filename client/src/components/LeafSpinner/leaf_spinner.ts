export const leaf_spinner = `<div class="leaf-spinner">
  <svg class="leaf-spinner__outer-circle" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="25 25 50 50">
    <circle cx="50" cy="50" r="22" fill="none" stroke="#26374A" stroke-width="2" shape-rendering='auto'/>
  </svg>
  <svg class="leaf-spinner__inner-circle" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="25 25 50 50">
    <circle cx="50" cy="50" r="20" fill="none" stroke="#2C70C9" stroke-width="1" />
  </svg>
  <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 650 650">
    <path  
      fill="#FF0000"
      d="M314.7,562l5.2-99.1c0.3-6-4.4-11.1-10.4-11.4c-0.8,0-1.6,0-2.4,0.1l-98.7,17.3l13.3-36.8
