...
import { GlossaryItem } from "./glossary_components";
...
const PanelGlossary: React.FC<PanelGlossaryProps> = ({ keys }) => {
  if (_.isEmpty(keys)) {
    return null;
  }
...
/* plural: "Government of Canada"
singular: "Government of Canada"
subject_type: "gov"
*/
