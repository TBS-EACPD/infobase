...
const get_rules = ({
  ...
  return [
    ...
    { // these wretched modules have the gall to throw modern JS in our face. Have to respect dropping IE11 support, but we aren't there yet ourselves. Transpile 'em!
